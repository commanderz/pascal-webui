...
function webui_show(window: size_t; content: PChar): LongBool; cdecl;
function webui_show_browser(window: size_t; content: PChar; browser: size_t): LongBool; cdecl;
procedure webui_set_kiosk(window: size_t; status: LongBool); cdecl;
...
function webui_set_root_folder(window: size_t; path: PChar): LongBool; cdecl;
function webui_is_shown(window: size_t): LongBool; cdecl;
procedure webui_set_timeout(second: size_t); cdecl;
procedure webui_set_icon(window: size_t; icon: PChar; icon_type: PChar); cdecl;
procedure webui_set_multi_access(window: size_t; status: LongBool); cdecl;
procedure webui_run(window: size_t; script: PChar); cdecl;
function webui_script(window: size_t; script: PChar; timeout: size_t; buffer: PChar; buffer_length: size_t): LongBool; cdecl;
...
function webui_interface_is_app_running: LongBool; cdecl;
...
function webui_show(window: size_t; content: PChar): LongBool; cdecl; external WebUILib;
function webui_show_browser(window: size_t; content: PChar; browser: size_t): LongBool; cdecl; external WebUILib;
procedure webui_set_kiosk(window: size_t; status: LongBool); cdecl; external WebUILib;
...
function webui_set_root_folder(window: size_t; path: PChar): LongBool; cdecl; external WebUILib;
function webui_is_shown(window: size_t): LongBool; cdecl; external WebUILib;
...
procedure webui_set_multi_access(window: size_t; status: LongBool); cdecl; external WebUILib;
procedure webui_run(window: size_t; script: PChar); cdecl; external WebUILib;
function webui_script(window: size_t; script: PChar; timeout: size_t; buffer: PChar; buffer_length: size_t): LongBool; cdecl; external WebUILib;
...
function webui_get_bool(e: Pwebui_event_t): LongBool; cdecl; external WebUILib;
...
procedure webui_return_bool(e: Pwebui_event_t; b: LongBool); cdecl; external WebUILib;
...
function webui_interface_is_app_running: LongBool; cdecl; external WebUILib;
